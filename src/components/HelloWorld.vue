        ...
        <nav class="relative max-w-7xl mx-auto flex items-center justify-between pt-6 pb-2 px-4 sm:px-6 lg:px-8" aria-label="Global">
          <div class="flex items-center justify-between w-full lg:w-auto">
            ...
            <div class="-mr-2 flex items-center lg:hidden">
              <PopoverButton class="bg-sky-800 bg-opacity-0 rounded-md p-2 inline-flex items-center justify-center text-cyan-100 hover:bg-opacity-100 focus:outline-none focus:ring-2 focus-ring-inset focus:ring-white">
      ...
      <div class="max-w-md mx-auto py-12 px-4 sm:max-w-3xl sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          <div class="space-y-8 xl:col-span-1">
            ...
            <p class="text-warm-gray-500 text-base">Making the world a better place through constructing elegant hierarchies.</p>
          ...
          <div class="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
            <div class="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 class="text-sm font-semibold text-warm-gray-700 tracking-wider uppercase">Solutions</h3>
              ...
              <div class="mt-12 md:mt-0">
                <h3 class="text-sm font-semibold text-warm-gray-700 tracking-wider uppercase">Support</h3>
                <ul role="list" class="mt-4 space-y-4">
            ...
            <div class="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 class="text-sm font-semibold text-warm-gray-700 tracking-wider uppercase">Company</h3>
                <ul role="list" class="mt-4 space-y-4">
              ...
              <div class="mt-12 md:mt-0">
                <h3 class="text-sm font-semibold text-warm-gray-700 tracking-wider uppercase">Legal</h3>
                <ul role="list" class="mt-4 space-y-4">
